...
public class Upload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		 ...
		 * retrieveFileName(part); }
		 */
		String path = request.getParameter("fileUpload").replace("\\", "/");
		System.out.println("path" + path);
		// java.io.File uploadFile = new
		// java.io.File("C:/Users/kasun_000/Desktop/Assign2_SSD/test.txt");
		java.io.File uploadFile = new java.io.File(path);

		// Create Google File:

		File googleFile = createGoogleFile(null, "text/plain", "newfile.txt",
				uploadFile);
